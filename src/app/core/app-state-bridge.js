...
export function createAppStateBridge(deps) {
  return {
    ...
    overlayState: {
      ...
      getSelectionRotationActive: deps.overlayState.getSelectionRotationActive ?? (() => false),
      setSelectionRotationActive: deps.overlayState.setSelectionRotationActive ?? (() => {}),
      getSelectionPivot: deps.overlayState.getSelectionPivot ?? (() => null),
      setSelectionPivot: deps.overlayState.setSelectionPivot ?? (() => {}),
