...
export function createAppStateBridge(deps) {
  return {
    ...
    overlayState: {
      ...
      getPlacementRedirectedHoverAtomIds: deps.overlayState.getPlacementRedirectedHoverAtomIds ?? (() => new Set()),
      ...
      getPaintMode: deps.overlayState.getPaintMode,
      setPaintMode: deps.overlayState.setPaintMode,
      getPaintTool: deps.overlayState.getPaintTool,
