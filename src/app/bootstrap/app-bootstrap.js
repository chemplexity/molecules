  ...
  const optionsModal = ctx.factories.initOptionsModal(
    ctx.factories.createOptionsModalDeps({
      ...
      dom: {
        ...
        getSelectionHighlightColorElement: () => ctx.dom.getSelectionHighlightColorElement?.() ?? null,
        getFunctionalGroupHighlightColorElement: () => ctx.dom.getFunctionalGroupHighlightColorElement?.() ?? null,
        getPhysicochemicalHighlightColorElement: () => ctx.dom.getPhysicochemicalHighlightColorElement?.() ?? null,
  ...
  const appShell = ctx.factories.initAppShell(
    ctx.factories.createAppShellDeps({
      ...
      input: {
        ...
        pickRandomCatalogMolecule: () => ctx.input.inputControls.pickRandomCatalogMolecule(),
