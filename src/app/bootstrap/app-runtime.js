...
export function createAppRuntime(deps) {
  ...
  deps.runtimeState.sessionUiState = deps.factories.createSessionUiStateBridge({
    ...
    getPaintColor: deps.selection.getPaintColor,
    getPaintBrushSize: deps.selection.getPaintBrushSize,
    getPaintOpacity: deps.selection.getPaintOpacity,
    getChargeTool: deps.selection.getChargeTool,
    getDrawBondElement: deps.selection.getDrawBondElement,
    getDrawBondType: deps.selection.getDrawBondType,
