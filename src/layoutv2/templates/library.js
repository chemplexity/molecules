...
function createPolycyclicPerimeterTemplate(templateId, atomSpecs, perimeterBondProperties, sharedBondSpecs) {
  ...
  for (let index = 0; index < atomSpecs.length; index++) {
    molecule.addBond(
      `b${index}`,
      `a${index}`,
      `a${(index + 1) % atomSpecs.length}`,
      { ...(perimeterBondProperties[index] ?? {}) },
      false
    );
  }
  for (let index = 0; index < sharedBondSpecs.length; index++) {
    ...
    molecule.addBond(
      `b${atomSpecs.length + index}`,
      `a${sharedBondSpec.firstIndex}`,
      `a${sharedBondSpec.secondIndex}`,
      { ...(sharedBondSpec.properties ?? {}) },
      false
    );
  }
  return molecule;
 ...
 */
function createFusedPerimeterTemplate(
  templateId,
  atomSpecs,
  perimeterBondProperties,
  firstSharedIndex,
  secondSharedIndex,
  sharedBondProperties
) {
...
function createSteroidCoreUnsaturatedTemplate() {
  return createRingSystemTemplateFromSmiles(
    ...
    'C[C@]12CC[C@H]3[C@@H](CC=C4C[C@@H](O)CC[C@]34C)[C@@H]1CC[C@@H]2=O'
  );
}
...
function createFiveSixFusedGeometry() {
  ...
  return freezeCoordEntries(centeredEntries(new Map([
...
export const PLANAR_VALIDATION = Object.freeze({
...
const TEMPLATE_LIBRARY = Object.freeze(
  [
    ...
    createTemplate(
      ...
      'bridged',
      55,
      createCubaneTemplate(),
      geometrySpec('normalized-xy', createCubaneGeometry(), BRIDGED_VALIDATION)
    ),
    createTemplate(
      'norbornane',
      'bridged',
    ...
    createTemplate(
      ...
      'fused',
      49,
      createQuinolineTemplate(),
      geometrySpec('normalized-xy', createQuinolineGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'isoquinoline',
      'fused',
      48,
      createIsoquinolineTemplate(),
      geometrySpec('normalized-xy', createIsoquinolineGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'indole',
      'fused',
      47,
      createIndoleTemplate(),
      geometrySpec('normalized-xy', createIndoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'benzimidazole',
      'fused',
    ...
    createTemplate(
      ...
      'fused',
      45,
      createBenzoxazoleTemplate(),
      geometrySpec('normalized-xy', createBenzoxazoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'benzothiazole',
      'fused',
      44,
      createBenzothiazoleTemplate(),
      geometrySpec('normalized-xy', createBenzothiazoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'indazole',
      'fused',
      43.5,
      createIndazoleTemplate(),
      geometrySpec('normalized-xy', createIndazoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'benzotriazole',
      'fused',
      43.25,
      createBenzotriazoleTemplate(),
      geometrySpec('normalized-xy', createBenzotriazoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'purine',
      'fused',
      43,
      createPurineTemplate(),
      geometrySpec('normalized-xy', createPurineGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'indane',
      'fused',
    ...
    createTemplate(
      ...
      'fused',
      40.8,
      createTetralinTemplate(),
      geometrySpec('normalized-xy', createTetralinGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'chromane',
      'fused',
      40.7,
      createChromaneTemplate(),
      geometrySpec('normalized-xy', createChromaneGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'isochromane',
      'fused',
      40.6,
      createIsochromaneTemplate(),
      geometrySpec('normalized-xy', createIsochromaneGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'quinazoline',
      'fused',
      42.5,
      createQuinazolineTemplate(),
      geometrySpec('normalized-xy', createQuinazolineGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'quinoxaline',
      'fused',
      41.5,
      createQuinoxalineTemplate(),
      geometrySpec('normalized-xy', createQuinoxalineGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'acridine',
      'fused',
      41,
      createAcridineTemplate(),
    ...
    createTemplate(
      ...
      'fused',
      40.95,
      createPyreneTemplate(),
      geometrySpec('normalized-xy', createPyreneGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'fluorene',
      'fused',
      40.94,
      createFluoreneTemplate(),
    ...
    createTemplate(
      ...
      'fused',
      40.75,
      createAnthraceneTemplate(),
      geometrySpec('normalized-xy', createAnthraceneGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'phthalazine',
      'fused',
    ...
    createTemplate(
      ...
      'isolated-ring',
      39,
      createPyridineTemplate(),
      geometrySpec('normalized-xy', createPyridineGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'pyrimidine',
      'isolated-ring',
      38,
      createPyrimidineTemplate(),
      geometrySpec('normalized-xy', createPyrimidineGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'pyrazine',
      'isolated-ring',
      37,
      createPyrazineTemplate(),
      geometrySpec('normalized-xy', createPyrazineGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'pyridazine',
      'isolated-ring',
      36,
      createPyridazineTemplate(),
      geometrySpec('normalized-xy', createPyridazineGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'triazine-1-2-3',
      'isolated-ring',
      35,
      createTriazine123Template(),
      geometrySpec('normalized-xy', createTriazine123Geometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'triazine-1-2-4',
      'isolated-ring',
      34,
      createTriazine124Template(),
      geometrySpec('normalized-xy', createTriazine124Geometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'triazine-1-3-5',
      'isolated-ring',
      33,
      createTriazine135Template(),
      geometrySpec('normalized-xy', createTriazine135Geometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'benzene',
      'isolated-ring',
    ...
    createTemplate(
      ...
      'isolated-ring',
      29,
      createPyrroleTemplate(),
      geometrySpec('normalized-xy', createPyrroleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'furan',
      'isolated-ring',
      28,
      createFuranTemplate(),
      geometrySpec('normalized-xy', createFuranGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'thiophene',
      'isolated-ring',
      27,
      createThiopheneTemplate(),
      geometrySpec('normalized-xy', createThiopheneGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'imidazole',
      'isolated-ring',
      26,
      createImidazoleTemplate(),
      geometrySpec('normalized-xy', createImidazoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'pyrazole',
      'isolated-ring',
      25,
      createPyrazoleTemplate(),
      geometrySpec('normalized-xy', createPyrazoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'oxazole',
      'isolated-ring',
      24,
      createOxazoleTemplate(),
      geometrySpec('normalized-xy', createOxazoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'isoxazole',
      'isolated-ring',
      23,
      createIsoxazoleTemplate(),
      geometrySpec('normalized-xy', createIsoxazoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'thiazole',
      'isolated-ring',
      22.5,
      createThiazoleTemplate(),
      geometrySpec('normalized-xy', createThiazoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'isothiazole',
      'isolated-ring',
      21.5,
      createIsothiazoleTemplate(),
      geometrySpec('normalized-xy', createIsothiazoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'triazole-1-2-3',
      'isolated-ring',
      20.5,
      createTriazole123Template(),
      geometrySpec('normalized-xy', createTriazole123Geometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'triazole-1-2-4',
      'isolated-ring',
      19.5,
      createTriazole124Template(),
      geometrySpec('normalized-xy', createTriazole124Geometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'tetrazole',
      'isolated-ring',
      22,
      createTetrazoleTemplate(),
      geometrySpec('normalized-xy', createTetrazoleGeometry(), PLANAR_VALIDATION)
    ),
    createTemplate(
      'cyclohexane',
      'isolated-ring',
